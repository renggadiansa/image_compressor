...
public class MainActivity extends AppCompatActivity {
    ...
    File path = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/ImageCompressor/");
    @Override
        ...
        btnCompress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(MainActivity.this, "foto saved", Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    e.printStackTrace();
